        ...
        <section className="md:px-10 mt-10">
            ...
            <section>
                <div className='border rounded-lg pb-10'>
                    ...
                    <div className="px-5">
                        <Link to="/my-courses" className="inline-block rounded px-6 py-2 text-sm font-bold bg-[#fff7eb] border border-primary-theme text-secondary-foreground uppercase hover:bg-white transition">
                            To Courses
                        </Link>
                    </div>
                </div>
